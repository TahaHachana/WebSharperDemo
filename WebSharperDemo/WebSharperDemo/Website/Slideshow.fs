...
module Slideshow =
        ...
        let slideRight () =
            slider.Animate(
                ...
                (fun () ->
                    slider.Css("left", frameWidth').Ignore
                    JQuery.Of(".slide").Filter(":first")
                        .Before(JQuery.Of(".slide").Filter(":last")).Ignore)).Ignore
    ...
    let slides =
        [
            {Src = "Images/Carousel/Slide1.jpg"; Alt = "Slide 1";
                Heading = "Slide 1"; Description = "Slide 1 description"; Href = "#"}
            {Src = "Images/Carousel/Slide2.jpg"; Alt = "Slide 2";
                Heading = "Slide 2"; Description = "Slide 2 description"; Href = "#"}
            {Src = "Images/Carousel/Slide3.jpg"; Alt = "Slide 3";
                Heading = "Slide 3"; Description = "Slide 3 description"; Href = "#"}
            {Src = "Images/Carousel/Slide4.jpg"; Alt = "Slide 4";
